 ...
 */
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSwiper() {
            const sliderElement = document.querySelector(".why__slider");
            if (sliderElement) new core(".why__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                on: {}
            }); else console.error("Element with class .why__slider not found.");
        }
